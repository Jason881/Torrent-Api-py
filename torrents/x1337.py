...
class x1337:
    ...
    async def search(self, query, page, limit):
        async with aiohttp.ClientSession() as session:
            ...
            url = f"{self.BASE_URL}/search/{query}/{page}/"
    ...
    async def trending(self, category, page, limit):
        async with aiohttp.ClientSession() as session:
            ...
            if not category:
                ...
                url = f"{self.BASE_URL}/popular-{category.lower()}"
    ...
    async def recent(self, category, page, limit):
        async with aiohttp.ClientSession() as session:
            ...
            if not category:
                ...
                url = f"{self.BASE_URL}/cat/{str(category).capitalize()}/{page}/"
            return await self.parser_result(start_time, url, session, page)
    ...
    async def search_by_category(self, query, category, page, limit):
        async with aiohttp.ClientSession() as session:
            start_time = time.time()
            self.LIMIT = limit
            url = f"{self.BASE_URL}/category-search/{query}/{category.capitalize()}/{page}/"
